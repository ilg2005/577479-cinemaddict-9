export const getPopupMarkup = (poster, age, title, original, rating, yourRate, director, writers, actors, date, duration, country, genres) => (`
        ...
        <div class="film-details__info">
          <div class="film-details__info-head">
            ...
            <div class="film-details__rating">
              ...
              <p class="film-details__user-rating">Your rate ${yourRate}</p>
            </div>
          </div>
